# This is a matlab script that scans YX and YZ images, generates the XZ matrix, produces several plots of histograms of Y and XZ axis density distribution
# Y axis is depth in the pot, Z and X are side and front/back axes of the pot. 

function generatePlots(yxBinaryImage, yzBinaryImage, barWidth_xyz, figureTitle, opName)
